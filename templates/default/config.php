...
return array(
	...
	*/
	...
	'events' => array(
		...
		{
			$theme->setTitle('Default Bootstrap Admin Template');
			$theme->setAuthor('Choji Takada');
			$theme->setKeywords('Administration Panel, Laravel');
		},

		'asset' => function($asset)
		{
			$asset->templatePath()->add([
										['style', 'css/style.css'],
										['script', 'js/script.js']
									 ]);
		...
		'beforeRenderTemplate' => function($template)
		{
