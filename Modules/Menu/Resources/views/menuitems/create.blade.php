                                    ...
                                    <form method="POST" action="{{ route('menuitems.store', $menu) }}">
                                        ...
                                        <div class="form-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                <input type="input" class="form-control" name="title" placeholder="Enter Title" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                <input type="input" class="form-control" name="slug" placeholder="Enter Slug" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="title" class="col-sm-2 col-form-label">URL</label>
                                                <div class="col-sm-10">
                                                <input type="input" class="form-control" name="url" placeholder="Enter URL" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="title" class="col-sm-2 col-form-label">Level</label>
                                                <div class="col-sm-10">
                                                <input type="input" class="form-control" name="level" placeholder="Enter Level" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="title" class="col-sm-2 col-form-label">Ordering</label>
                                                <div class="col-sm-10">
                                                <input type="input" class="form-control" name="order" placeholder="Enter Order" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
